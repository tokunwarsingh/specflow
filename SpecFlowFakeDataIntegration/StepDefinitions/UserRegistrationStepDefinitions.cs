...
using SpecFlowFakeDataIntegration.PageObject;
using System;
using TechTalk.SpecFlow;
using AutoFixture;

namespace SpecFlowFakeDataIntegration.StepDefinitions
{
    [Binding]
    public class UserRegistrationStepDefinitions
    {
        ...
        public void WhenUserEntersValidDetails()
        {
            ...
            RegistrationTestData testData = new Fixture().Create<RegistrationTestData>();
            */
